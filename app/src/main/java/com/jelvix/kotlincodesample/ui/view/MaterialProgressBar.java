...
public class MaterialProgressBar extends ProgressBar {
    ...
    public MaterialProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray styledAttributes = context.obtainStyledAttributes(attrs, R.styleable.MaterialProgressBar, defStyleAttr, 0);
        int backgroundColour;
        int progressColour;
        try {
            backgroundColour = styledAttributes.getColor(R.styleable.MaterialProgressBar_backgroundColour, 0);
            progressColour = styledAttributes.getColor(R.styleable.MaterialProgressBar_progressColour, 0);
            duration = styledAttributes.getInteger(R.styleable.MaterialProgressBar_duration, DEFAULT_DURATION);
        } finally {
